          ...
          <div className="mt-2 space-y-5">
              ...
              <div className="rounded-lg border border-gray-200 p-3">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border px-4 py-2 text-gray-700 focus:outline-none focus:border-blue-500"
                  />
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <div className="grid gap-3">
                      <input
                        ...
                        className="rounded-lg border px-4 py-2 text-gray-700 focus:outline-none focus:border-blue-500"
                      />
                      <input
                        type="text"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full min-h-[100px] rounded-lg border px-4 py-2 text-gray-700 focus:outline-none focus:border-blue-500"
